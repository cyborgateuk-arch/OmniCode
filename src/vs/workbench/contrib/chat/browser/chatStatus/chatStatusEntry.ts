...
export class ChatStatusBarEntry extends Disposable implements IWorkbenchContribution {
	...
	private getEntryProps(): IStatusbarEntry {
		...
		if (isNewUser(this.chatEntitlementService)) {
			...
			if (this.chatEntitlementService.sentiment.disabled || this.chatEntitlementService.sentiment.untrusted) {
				text = '$(circle-slash)';
				ariaLabel = localize('copilotDisabledStatus', "AI features unavailable");
			}
			...
			// Signed out
			else if (this.chatEntitlementService.entitlement === ChatEntitlement.Unknown && !this.chatEntitlementService.anonymous && !this.chatEntitlementService.hasByokModels) {
				return this.getSetupEntryProps();
			}
	...
	private getSetupEntryProps(): IStatusbarEntry {
		return {
			name: localize('chatStatus', "AI Status"),
			text: `$(chat-sparkle) ${localize('manageModelsShort', "Models")}`,
			ariaLabel: localize('manageModelsAria', "Manage AI models"),
