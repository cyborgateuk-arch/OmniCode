...
import './omniProxyManagement/omniProxyManagement.contribution.js';
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[ChatConfiguration.OfflineByok]: {
			type: 'boolean',
			description: nls.localize('chat.offlineByok', "Enable local BYOK chat features without GitHub sign-in."),
			default: true,
			scope: ConfigurationScope.WINDOW,
			included: false,
		},
		[ChatConfiguration.TitleBarSignInEnabled]: {
			type: 'boolean',
			description: nls.localize('chat.titleBar.signIn.enabled', "Controls whether the AI account button is shown in the title bar when external account access is needed. When disabled, the account affordance falls back to the status bar."),
			default: true,
		},
		...
		'chat.extensionUnification.enabled': {
			type: 'boolean',
			description: nls.localize('chat.extensionUnification.enabled', "Enables the unification of built-in AI extensions. When enabled, all built-in AI functionality is served from the primary AI extension. When disabled, the built-in AI extensions operate independently."),
			default: true,
			tags: ['experimental'],
			experiment: {
				mode: 'auto'
