...
export namespace ChatContextKeys {
	...
	export const chatModelsAvailable = new RawContextKey<boolean>('chatModelsAvailable', false, { type: 'boolean', description: localize('chatModelsAvailable', "True when at least one chat model is available.") });
