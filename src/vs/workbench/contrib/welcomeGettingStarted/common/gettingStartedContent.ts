...
export function copilotSettingsMessage(manageSettingsUrl: string): string {
	return localize({ key: 'settings', comment: ['{Locked="["}', '{Locked="]({0})"}'] }, "Manage custom providers, local models, and AI preferences from [settings]({0}) anytime.", manageSettingsUrl);
}
...
const CopilotStepTitle = localize('gettingStarted.copilotSetup.title', "Use OmniCode AI features");
const CopilotDescription = localize('gettingStarted.copilotSetup.description', "Use AI to generate code across multiple files, fix errors, ask questions about your code, and work with custom providers and local models.");
const CopilotTermsString = localize('gettingStarted.copilotSetup.terms', "AI features are enabled without sign-in. Manage models and providers anytime.");
...
const CopilotCompleteButton = Button(localize('setupCopilotButton.chatWithCopilot', "Open Chat"), 'command:workbench.action.chat.open');
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with OmniCode"),
		description: localize('gettingStarted.setup.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Setup OmniCode'),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
				createCopilotSetupStep('CopilotSetupAnonymous', CopilotAnonymousButton, 'chatAnonymous && !chatSetupCompleted', true),
				createCopilotSetupStep('CopilotSetupComplete', CopilotCompleteButton, '(chatSetupCompleted || github.copilot.hasByokModels) && !chatSetupDisabled && (chatAnonymous || github.copilot.hasByokModels || chatPlanPro || chatPlanProPlus || chatPlanMax || chatPlanBusiness || chatPlanEnterprise || chatPlanFree)', false),
				...
				},
				{
					...
					description: localize('gettingStarted.videoTutorial.description.interpolated', "Watch the first in a series of short and practical video tutorials for OmniCode's key features.\n{0}", Button(localize('watch', "Watch Tutorial"), 'https://aka.ms/vscode-getting-started-video')),
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get Started with OmniCode for the Web"),
		description: localize('gettingStarted.setupWeb.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: 'isWeb',
		next: 'Beginner',
		walkthroughPageTitle: localize('gettingStarted.setupWeb.walkthroughPageTitle', 'Setup OmniCode Web'),
		content: {
			type: 'steps',
			steps: [
				{
	...
	},
	{
		...
		description: localize('gettingStarted.setupAccessibility.description', "Learn the tools and shortcuts that make OmniCode accessible. Note that some actions are not actionable from within the context of the walkthrough."),
		isFeatured: true,
		icon: setupIcon,
		when: CONTEXT_ACCESSIBILITY_MODE_ENABLED.key,
		next: 'Setup',
		walkthroughPageTitle: localize('gettingStarted.setupAccessibility.walkthroughPageTitle', 'Setup OmniCode Accessibility'),
		content: {
			type: 'steps',
			steps: [
				{
