...
function shouldSendAntigravityUserProjectHeader(): boolean {
  return /^(1|true|yes)$/i.test(process.env.ANTIGRAVITY_INCLUDE_USER_PROJECT ?? "");
}
...
function applyAntigravityRuntimeHeaders(
  ...
  if (shouldSendAntigravityUserProjectHeader()) {
