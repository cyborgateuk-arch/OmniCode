...
suite('Policy E2E conversion', () => {
	...
	test('should render macOS policy profile from policies list', async () => {
		...
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'darwin', 'com.omnicode.mobileconfig');
	...
	test('should render macOS manifest from policies list', async () => {
		...
		// Load the expected fixture file
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'darwin', 'en-us', 'com.omnicode.plist');
		const expectedContent = await fs.readFile(fixturePath, 'utf-8');
	...
	test('should render Windows ADMX from policies list', async () => {
		...
		// Load the expected fixture file
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'win32', 'OmniCode.admx');
		const expectedContent = await fs.readFile(fixturePath, 'utf-8');
	...
	test('should render Windows ADML from policies list', async () => {
		...
		// Load the expected fixture file
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'win32', 'en-us', 'OmniCode.adml');
		const expectedContent = await fs.readFile(fixturePath, 'utf-8');
	...
	test('should render macOS manifest with fr-fr locale', async () => {
		...
		// Load the expected fixture file
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'darwin', 'fr-fr', 'com.omnicode.plist');
		const expectedContent = await fs.readFile(fixturePath, 'utf-8');
	...
	test('should render Windows ADML with fr-fr locale', async () => {
		...
		// Load the expected fixture file
		const fixturePath = path.join(import.meta.dirname, 'fixtures', 'policies', 'win32', 'fr-fr', 'OmniCode.adml');
		const expectedContent = await fs.readFile(fixturePath, 'utf-8');
