...
* [Developing](#developing)
  ...
  * [Running with OmniCode](#running-with-omnicode)
...
## Running with OmniCode

### Desktop

You can run the extension from OmniCode Desktop, provided that you follow along these steps:
- Create a top level `product.overrides.json` in the `vscode` repository
- Add below contents as JSON
- Run the extension launch configuration in OmniCode
...
OmniCode for Web unfortunately does not support the `product.overrides.json` trick. You have to manually copy the
...
Object.assign(product, {
		version: '1.102.0-dev',
		nameShort: 'OmniCode Dev',
		nameLong: 'OmniCode Dev',
		applicationName: 'omnicode',
		dataFolderName: '.vsomnicode',
		urlProtocol: 'omnicode',
